...
namespace BLL
{
    ...
    {
        private readonly DAL.ReplyQuestion dal = new DAL.ReplyQuestion();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Model.ReplyQuestion GetModelByCache(int ReplyID)
        {

            string CacheKey = "ReplyQuestionModel-" + ReplyID;
            ...
            return (Model.ReplyQuestion)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.ReplyQuestion> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.ReplyQuestion> DataTableToList(DataTable dt)
        {
            List<Model.ReplyQuestion> modelList = new List<Model.ReplyQuestion>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.ReplyQuestion model;
