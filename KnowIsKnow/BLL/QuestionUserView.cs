...
namespace BLL
{
    ...
    {
        private readonly DAL.QuestionUserView dal = new DAL.QuestionUserView();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.QuestionUserView> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.QuestionUserView> DataTableToList(DataTable dt)
        {
            List<Model.QuestionUserView> modelList = new List<Model.QuestionUserView>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.QuestionUserView model;
