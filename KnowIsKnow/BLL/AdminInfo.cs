...
namespace BLL
{
    ...
    {
        private readonly DAL.AdminInfo dal = new DAL.AdminInfo();
        public AdminInfo()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Model.AdminInfo GetModelByCache(int adminID)
        {
            ...
            return (Model.AdminInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.AdminInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.AdminInfo> DataTableToList(DataTable dt)
        {
            List<Model.AdminInfo> modelList = new List<Model.AdminInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.AdminInfo model;
