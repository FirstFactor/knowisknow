...
namespace BLL
{
    ...
    {
        private readonly DAL.CarePerson dal = new DAL.CarePerson();
        public CarePerson()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Model.CarePerson GetModelByCache(int carePersonID, int personCaredByUID)
        {

            string CacheKey = "CarePersonModel-" + carePersonID + personCaredByUID;
            ...
            return (Model.CarePerson)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.CarePerson> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.CarePerson> DataTableToList(DataTable dt)
        {
            List<Model.CarePerson> modelList = new List<Model.CarePerson>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.CarePerson model;
