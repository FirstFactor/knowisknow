...
namespace BLL
{
    ...
    {
        private readonly DAL.TopicInfo dal = new DAL.TopicInfo();
        public TopicInfo()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Model.TopicInfo GetModelByCache(int topicID)
        {

            string CacheKey = "TopicInfoModel-" + topicID;
            ...
            return (Model.TopicInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.TopicInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.TopicInfo> DataTableToList(DataTable dt)
        {
            List<Model.TopicInfo> modelList = new List<Model.TopicInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.TopicInfo model;
