...
namespace BLL
{
    ...
    {
        private readonly DAL.MessageInfo dal = new DAL.MessageInfo();
        public MessageInfo()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Model.MessageInfo GetModelByCache(int MessageID)
        {
            ...
            return (Model.MessageInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.MessageInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.MessageInfo> DataTableToList(DataTable dt)
        {
            List<Model.MessageInfo> modelList = new List<Model.MessageInfo>();
