                ...
                <div class="settings-section">
                    <div class="settings-item clearfix">
                        ...
                        <div class="settings-item-content rename-section" id="rename-section">
                            <span class="name" runat="server" id="xingming"></span>
                            ...
                            <div class="rename-tab hidden">
                                <p>
                                    <input class="zg-form-text-input half ximg" type="text" name="lastname" placeholder="姓" id="zqyxing" />
                                    <input class="zg-form-text-input half ming" type="text" name="firstname" placeholder="名" id="zqyming" />

                                </p>
                                <div class="note gray"></div>
                            </div>
                            <div runat="server" id="cfuserid" style="display: none;" class="hquserid"></div>
                            <div runat="server" id="cfuserpwd" style="display: none;" class="hquserpwd"></div>
                        </div>
                    </div>
                    <div class="settings-item clearfix">
                    ...
                    <div class="settings-item clearfix">
                        ...
                        <div class="settings-item-content">
                            <div class="zg-form-text-input  zqyemail" id="wodeemail" runat="server"></div>
                    ...
                    <div class="settings-save">
                        <button type="submit" class="clickbc xiugaimz">保存</button>
                    </div>
                </div>
            </div>
            ...
            <div class="mianform f2 hidden">
                ...
                <div class="settings-section">
                    ...
                    <div class="settings-item clearfix">
                        ...
                        <div class="settings-item-content">
                            <input type="password" autocomplete="off" class="zg-form-text-input dqmima" name="op" id="op" placeholder="当前密码" required="" />
                        </div>
                    </div>
                    ...
                    <div class="settings-item clearfix">
                        ...
                        <div class="settings-item-content">
                            <input data-rule-strongpassword="true" type="password" autocomplete="off" class="zg-form-text-input xdmima" name="np" id="np" placeholder="新的密码" required="" />
                        </div>
                    </div>
                    <div class="settings-item clearfix">
                        <label for="rp" class="settings-item-title with-input">确认密码</label>
                        <div class="settings-item-content">
                            <input type="password" autocomplete="off" class="zg-form-text-input qrmima" name="rp" id="rp" placeholder="确认密码" required="" />
                        </div>
                    </div>
                    <div class="settings-save">
                        <div class="clickbc baocunmima">保存</div>
                    </div>
                </div>
            ...
            <div class="mianform f3 hidden">
                ...
                <div class="settings-section1 noti">
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label">
                                <input checked="" type="checkbox" name="subscribe_member_follow" value="1" />
                                有人关注我
                            </label>
                        </div>
                    </div>
                    <div class="settings-item1 clearfix">
                        ...
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="subscribe_question_invite" value="3" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_question_invite" value="1" />
                                我关注的人
                            </label>
                        </div>
                    </div>
                    <div class="settings-item1 clearfix">
                        ...
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="subscribe_answer_vote" value="3" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_answer_vote" value="1" />
                                我关注的人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_answer_vote" value="0" />
                                我不接受此类通知
                            </label>
                        </div>
                    </div>
                    <div class="settings-item1 clearfix">
                        ...
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="subscribe_answer_thank" value="3" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_answer_thank" value="1" />
                                我关注的人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_answer_thank" value="0" />
                                我不接受此类通知
                            </label>
                        </div>
                    </div>
                    <div class="settings-item1 clearfix">
                        ...
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="subscribe_comment_like" value="3" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_comment_like" value="1" />
                                我关注的人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_comment_like" value="0" />
                                我不接受此类通知
                            </label>
                        </div>
                    </div>
                    <div class="settings-item1 clearfix">
                        ...
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="subscribe_column_article_vote" value="3" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_column_article_vote" value="1" />
                                我关注的人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_column_article_vote" value="0" />
                                我不接受此类通知
                            </label>
                        </div>
                    </div>
                    <div class="settings-item1 clearfix">
                        ...
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="subscribe_column_follow" value="3" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_column_follow" value="1" />
                                我关注的人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="subscribe_column_follow" value="0" />
                                我不接受此类通知
                            </label>
                        </div>
                    </div>
                ...
                <div class="settings-section2 noti">
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-radio-label">
                                <input checked="" type="radio" name="recv_option" value="0" />
                                所有人
                            </label>
                            <label class="settings-radio-label">
                                <input type="radio" name="recv_option" value="1" />
                                我关注的人
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label gray">
                                <input type="checkbox" name="subscribe_question_answered" value="1" />
                                我接受所关注问题的全部新回答的通知，即便这些回答与问题的相关度可能不够高
                            </label>
                        </div>
                    </div>
            ...
            <div class="mianform f4 hidden">
                <div class="settings-section noti">
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label">
                                <input id="action_153" name="action_153" type="checkbox" value="y" />
                                有人关注了我
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label">
                                <input checked="" id="action_61" name="action_61" type="checkbox" value="y" />
                                有人邀请我回答一个问题
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label">
                                <input checked="" id="action_251" name="action_251" type="checkbox" value="y" />
                                有人向我发送私信
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="settings-item1 clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label">
                                <input checked="" id="promotion" name="promotion" type="checkbox" value="y" />
                                接收来自知乎的新产品发布、热点内容、活动信息等邮件
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="settings-item clearfix">
                            <div class="settings-item-content">
                                <div id="zh-topic-block-editors" class="zm-tag-editor zg-section">
                                    <div class="zm-tag-editor-labels clearfix" style="display: none;"></div>
                                    <div class="zm-tag-editor-editor">
                                        <div class="zg-section zg-clear"></div>
                                        <div class="zg-section zm-tag-editor-command-buttons-wrap">
                                            <input class="zg-form-text-input zg-mr15 label-input-label" type="text" placeholder="搜索话题" title="搜索话题" aria-haspopup="true"><a class="zg-mr15 zg-btn-blue" href="#" name="add" style="display: none;">添加</a><a href="#" name="close" style="display: none;">完成</a></div>
                                        <div class="zm-tag-editor-maxcount zg-section" style="display: none;"><span>最多只能为一个问题绑定 Infinity 个话题</span><a href="#" name="close">完成</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="settings-section4">
                        <div class="settings-section-title">
                            ...
                            <p class="settings-section-desc">
                                ...
                                详情参见 <a class="zg-link-litblue" href="http://www.zhihu.com/question/20806546">知乎上的哪些内容需要主动关注才会出现在首页动态中？</a>
                            </p>
                        </div>
                        <div class="settings-item clearfix">
                            <div class="settings-item-content">
            ...
            <div class="mianform f7 hidden">
                <div class="settings-section noti">
                    ...
                    <div class="settings-item clearfix">
                        <div class="settings-item-content">
                            <label class="settings-checkbox-label">
                                <input type="checkbox" name="use_topstory" value="1" />
                                开启新版首页动态体验
