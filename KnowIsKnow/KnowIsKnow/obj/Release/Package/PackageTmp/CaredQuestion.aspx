						...
						<div class="zqq-question-area">
                            ...
                            <ItemTemplate>
							    ...
							    <div class="zqq-question-detail">
                                    ...
                                    <a href='QuestionDetail.aspx?QuesID=<%# Eval("careQuestionID")%>' class="zqq-question-title" questionid='<%# Eval("careQuestionID") %>' ><%# GetContentSummary( Eval("questionTitle").ToString(),20,true) %></a>
