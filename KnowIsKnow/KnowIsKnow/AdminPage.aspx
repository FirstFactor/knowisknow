        ...
        <div id="adContentArea">
            ...
            <div class="adOperaDetail alterTopic">
                <div class="adSearchArea">
                    ...
                    <div class="checkTopicState" style="float: right">
                        <div class="zhengchang" divid="normallist" style="float: left; cursor: pointer; margin-right: 10px;">正常话题</div>
                        <div class="buzhengchang" href="#" divid="unnormallist" style="float: left; cursor: pointer;">已删话题</div>
                        <div class="clear"></div>
                    </div>
                </div>
            ...
            <div class="adOperaDetail dealReport">
                ...
                <div class="reportlistArea">
                    <div class="reportlist reportques">
                        <ul>
                            <li><span class="questionTitle">Title</span> <span class="reportReason">reason</span> <span class="reportOperation">operation1</span>
                                <div class="clear"></div>
                            </li>

                            <asp:Repeater runat="server" ID="rptreportQeslist">
                                <ItemTemplate>
                                    <li><span class="questionTitle"><a href="QuestionDetail.aspx?QuesID=<%#Eval("questionID")%>"><%# Eval("questionTitle") %></a></span> <span class="reportReason"><%#Eval("reportReasonContent") %><%#Eval("reportQuestionReason") %></span>
                                        <div class="reportOperationArea">
                                            <dl class="reportOperation1 repop">
                                                <dt class="selectop">处理</dt>
                                                <dd class="op" state="delete" reportid="<%#Eval("reportQuID")%>">删除</dd>
                                                <dd class="op" state="ignore">忽略</dd>
                                            </dl>
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                    ...
                    <div class="reportlist reportrep">
                        <ul>
                            ...
                            <asp:Repeater runat="server" ID="rtpReportReply">
                                <ItemTemplate>
                                    <li><span class="questionTitle"><a href="QuestionDetail.aspx?QuesID=<%# Eval("replyQuestionID")%>#mao<%# Eval("reportReplyID") %>"><%# Eval("replyContent") %></a></span> <span class="reportReason"><%#Eval("reportReasonContent") %><%#Eval("reportReplyReason") %></span>
                                        <div class="reportOperationArea">
                                            <dl class="reportOperation1 repop">
                                                <dt class="selectop">处理</dt>
                                                <dd class="op" state="deleteReportReply" reportid="<%#Eval("reportReID")%>">删除</dd>
                                                <dd class="op" state="ignore">忽略</dd>
                                            </dl>
                                        </div>
                                    </li>
